#ifndef ENGINE_COMMON_DATA_DATABASE_STATE_HPP
#define ENGINE_COMMON_DATA_DATABASE_STATE_HPP
#pragma once
...
namespace engine
{
	...
	namespace data
	{
		...
		public:
			...
			static database_changes_t calculate_changes(database_state_t & current, database_state_t & previous);

		private:

			typedef std::set<ustring_t> changed_directories_t;

			static void mark_changed_directories(const virtual_path_t & path, database_changes_t * output, changed_directories_t * directories);
