...
namespace engine
{
	...
	SETTINGS_START(logger_output_t, normal)
		...
		SETTINGS_SET(ustring_t, format_file_task_started, "msg ###1:id##>10# <#2:module#> #3:message#...#>125#   frame: #7:frame#, time: #8:time#, thread: #9:thread#, func: #4:function#()#>253#   at: #5:file#, on line: #6:line#"_u)
		...
		SETTINGS_SET(ustring_t, format_file_task_failed, "ERR ###1:id##>10# <#2:module#> FAILED ###10:link#: '#3:message#'#>125#   frame: #7:frame#, time: #8:time#, thread: #9:thread#, func: #4:function#()#>253#   at: #5:file#, on line: #6:line#"_u)
		...
		SETTINGS_SET(ustring_t, format_file_task_done, "msg ###1:id##>10# <#2:module#> Completed ###10:link#: '#3:message#'#>125#   frame: #7:frame#, time: #8:time#, thread: #9:thread#, func: #4:function#()#>253#   at: #5:file#, on line: #6:line#"_u)
		...
		SETTINGS_SET(ustring_t, format_file_message, "msg ###1:id##>10# <#2:module#> #3:message##>125#   frame: #7:frame#, time: #8:time#, thread: #9:thread#, func: #4:function#()#>253#   at: #5:file#, on line: #6:line#"_u)
		...
		SETTINGS_SET(ustring_t, format_file_warning, "WRN ###1:id##>10# <#2:module#> #3:message##>125#   frame: #7:frame#, time: #8:time#, thread: #9:thread#, func: #4:function#()#>253#   at: #5:file#, on line: #6:line#"_u)
		...
		SETTINGS_SET(ustring_t, format_file_error, "ERR ###1:id##>10# <#2:module#> #3:message##>125#   frame: #7:frame#, time: #8:time#, thread: #9:thread#, func: #4:function#()#>253#   at: #5:file#, on line: #6:line#"_u)
