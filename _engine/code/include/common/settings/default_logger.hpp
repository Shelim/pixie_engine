...
namespace engine
{
	...
	SETTINGS_START(logger_output_t, normal)
		...
		SETTINGS_SET(ustring_t, format_file_task_failed, "###1:id# !!! <#2:module#> #3:message#... [FAILED!]#>61#   frame: #7:frame#, time: #8:time#, thread: #9:thread#, func: #4:function#()#>125#   at: '#5:file#', on line: #6:line#"_u)
		...
		SETTINGS_SET(ustring_t, format_file_task_done, "###1:id# ..> <#2:module#> #3:message#... [Ok]#>61#   frame: #7:frame#, time: #8:time#, thread: #9:thread#, func: #4:function#()#>125#   at: '#5:file#', on line: #6:line#"_u)
		...
		SETTINGS_SET(ustring_t, format_file_message, "###1:id# --> <#2:module#> #3:message##>61#   frame: #7:frame#, time: #8:time#, thread: #9:thread#, func: #4:function#()#>125#   at: '#5:file#', on line: #6:line#"_u)
		...
		SETTINGS_SET(ustring_t, format_file_warning, "###1:id# -!- <#2:module#> #3:message##>61#   frame: #7:frame#, time: #8:time#, thread: #9:thread#, func: #4:function#()#>125#   at: '#5:file#', on line: #6:line#"_u)
		...
		SETTINGS_SET(ustring_t, format_file_error, "###1:id# !!! <#2:module#> #3:message##>61#   frame: #7:frame#, time: #8:time#, thread: #9:thread#, func: #4:function#()#>125#   at: '#5:file#', on line: #6:line#"_u)
