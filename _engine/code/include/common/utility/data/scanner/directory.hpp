...
namespace engine
{
	namespace data
	{
		...
		public:
			...
			scanner_directory_t(virtual_path_t base_virtual_path, const virtual_path_t::path_t & base_physical_path, bool is_read_only) : base_virtual_path(base_virtual_path), base_physical_path(base_physical_path.get_cstring()), is_read_only(is_read_only)
			{
