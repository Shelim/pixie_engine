...
#define ALL_COMPONENTS_BY_DEFAULT_ARE(type) engine::global::injector_##type(),
...
#define DISABLE_COMPONENT(component) boost::di::bind<engine::component##_t>().in(engine::global::shared).to <engine::component##_dummy_t>()[boost::di::override],
...
#define END_BOOTSTRAPPER() engine::global::injector_factorable() );
