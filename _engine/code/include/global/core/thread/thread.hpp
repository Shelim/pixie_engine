...
namespace engine
{
    ...
    class thread_t
    {
        ...
        public:
            ...
            thread_t(app_t::kind_t app, app_t::instance_id_t app_instance_id, std::shared_ptr<holder_t<accountable_thread_t> > notifier, const ustring_t & name, std::function<void()> thread_func, std::shared_ptr<holder_t<thread_stats_t> > stats_provider)
            {
    ...
    class thread_factory_t
    {
        ...
        public:
            ...
            thread_factory_t(std::shared_ptr<holder_t<accountable_thread_t> > notifier, std::shared_ptr<holder_t<thread_stats_t> > stats_provider) : notifier(notifier), stats_provider(stats_provider)
            {
            ...
            {
                return std::make_unique<thread_t>(app_t::kind_t::_engine, 0, notifier, name, thread_func, stats_provider);
            }
            ...
            {
                return std::make_unique<thread_t>(app, app_instance_id, notifier, name, thread_func, stats_provider);
            }
