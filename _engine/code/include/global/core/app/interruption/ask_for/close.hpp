...
namespace engine
{
    ...
    class interruption_ask_for_close_t : public interruption_ask_for_t
    {
        ...
        public:
            ...
            interruption_ask_for_close_t(app_t::instance_id_t target, callback_t on_allowed) : interruption_ask_for_t(type_t::ask_for_close, target, default_t::allowed, std::move(on_allowed))
            {
