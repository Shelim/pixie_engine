...
#define log_msg(app, instnace, source, ...) log(engine::console::logger_item_t::kind_t::msg, app, instance, engine::console::logger_item_t::source_t::source, engine::ustring_t::from_ascii(__FILE__), __LINE__, engine::ustring_t::from_ascii(__FUNCTION__), -1, __VA_ARGS__)
#define log_task_start(app, instnace, source, ...) log(engine::console::logger_item_t::kind_t::pending, app, instance, engine::console::logger_item_t::source_t::source, engine::ustring_t::from_ascii(__FILE__), __LINE__, engine::ustring_t::from_ascii(__FUNCTION__), -1, __VA_ARGS__)
...
#define log_warn(app, instnace, source, ...) log(engine::console::logger_item_t::kind_t::warning, app, instance, engine::console::logger_item_t::source_t::source, engine::ustring_t::from_ascii(__FILE__), __LINE__, engine::ustring_t::from_ascii(__FUNCTION__), -1, __VA_ARGS__)
#define log_err(app, instnace, source, ...) log(engine::console::logger_item_t::kind_t::error, app, instance, engine::console::logger_item_t::source_t::source, engine::ustring_t::from_ascii(__FILE__), __LINE__, engine::ustring_t::from_ascii(__FUNCTION__), -1, __VA_ARGS__)
