#ifndef ENGINE_COMPONENT_DATA_MANIPULATOR_DUMMY_HPP
#define ENGINE_COMPONENT_DATA_MANIPULATOR_DUMMY_HPP
#pragma once
...
namespace engine
{
	...
	class data_manipulator_dummy_t : public data_manipulator_t
	{

	public:

		data_manipulator_dummy_t()
		{
