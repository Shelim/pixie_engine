...
#ifndef GAME_LOGGER_DATA_VIRTUAL_PATH_STD
#define GAME_LOGGER_DATA_VIRTUAL_PATH_STD(...)
#endif

#ifndef GAME_LOGGER_RAW_VIRTUAL_PATH_STD
#define GAME_LOGGER_RAW_VIRTUAL_PATH_STD(...)
#endif
...
GAME_LOGGER_DATA_VIRTUAL_PATH_STD("log_" XSTR(PIXIE_OUTPUT_UNIX_NAME) ".xml")
GAME_LOGGER_RAW_VIRTUAL_PATH_STD("log_" XSTR(PIXIE_OUTPUT_UNIX_NAME) "_raw.log")
GAME_KEYBINDING_VIRTUAL_PATH_STD("keybinding.xml")

#undef GAME_KEYBINDING_VIRTUAL_PATH_STD
#undef GAME_CONFIG_VIRTUAL_PATH_STD
#undef GAME_LOGGER_RAW_VIRTUAL_PATH_STD
#undef GAME_LOGGER_DATA_VIRTUAL_PATH_STD
